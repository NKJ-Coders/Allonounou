<div class="modal fade" id="signalerDemandeModal{{ $allAnnonce->id }}" tabindex="-1" role="dialog" aria-labelledby="signalerModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('demande.signaler') }}" method="POST">
                    @csrf
                    {{-- <div class="row"> --}}
                        <input type="hidden" name="annonce_recruteur_id" value="{{ $allAnnonce->id }}">
